  ...
  return (
    <div className="bg-card border-2 border-text-primary retro-shadow p-6">
      ...
      <div className="flex items-baseline gap-1.5">
        <h2 className="text-3xl font-bold text-text-primary">{balance ? fmt(balance.iost) : "0"}</h2>
        <span className="text-sm text-text-secondary font-medium">IOST</span>
      </div>
      <p className="text-text-secondary text-sm mt-1">{balance ? `¥ ${balance.jpyEquivalent.toLocaleString("en-US")}` : "¥ 0"}</p>
